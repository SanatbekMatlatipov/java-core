...
//        System.out.println(greaterThanFifteen.and(lessThanOneHundred).test(50));
//        System.out.println(greaterThanFifteen.and(lessThanOneHundred).test(15));
//
